...
const taskList = [
  {
    title:
      "ffffffffffffffffffffffffffffffffffffffffffffggggggg hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh",
    comment:
...
console.log("стиль ", document.getElementsByClassName("taskList")[0].style);
...
function getTaskList(arrTask, index) {
  return `<tbody class="listTBody"><tr><td><b>${textDecoration(
    arrTask.title,
    arrTask.state
  )}</td></tr></b>
  <tr>
    <td>Описание: ${arrTask.comment}</td>
  </tr>
  <tr>
